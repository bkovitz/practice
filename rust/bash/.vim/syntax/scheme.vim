...
" UPDATED 28-Jul-2012 by Ben Kovitz:
"   Minimal update. What happened to my nice update from three years ago?
"   Allow #; #
" UPDATED 10-Nov-2012 by Ben Kovitz:
"   Added Unicode Greek letters and mathematical symbols.
...
syn match	schemeOther	oneline    ,[a-zΓ-ω∀-⋿⨀-⫿¬!$%&*/:<=>?^_~+@#%-][-a-zΓ-ω∀-⋿⨀-⫿¬!$%&*/:<=>?^_~0-9+.@#%]*,
syn match	schemeError	oneline    ,[a-zΓ-ω∀-⋿⨀-⫿¬!$%&*/:<=>?^_~+@#%-][-a-zΓ-ω∀-⋿⨀-⫿¬!$%&*/:<=>?^_~0-9+.@#%]*[^-a-zΓ-ω∀-⋿⨀-⫿¬!$%&*/:<=>?^_~0-9+.@ \t\[\]()";]\+[^ \t\[\]()";]*,
